...
<div>
    ...
    <button type="button" className="btn py-2 btn-primary position-relative m-4 float-start d-inline" onClick={() => window.location.reload()}>   
    ...
    <button type="button" className="btn py-2 btn-primary position-relative m-4 float-end d-inline">
    ...
    <CartModal />
    <button type="button" className="btn btn-primary position-relative my-4 py-2 float-end d-inline" data-bs-toggle="modal" data-bs-target="#productModal">
