    ...
    <div className="row p-4 pb-0 pe-lg-0 pt-lg-5 align-items-center rounded-3 border shadow-lg" style={{color: 'white'}}>
      <div className="col-lg-7 p-3 p-lg-5 pt-lg-3">
        ...
        <div className="d-grid gap-2 d-md-flex justify-content-md-start mb-4 mb-lg-3">
          <button type="button" className="btn btn-success btn-lg px-4 me-md-2 fw-bold">Shop Now!</button>
          <button type="button" className="btn-danger btn btn-lg px-4">Sell</button>
        </div>
      </div>
