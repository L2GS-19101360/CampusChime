...
var require_react_router_dom_min = __commonJS({
  "node_modules/react-router-dom/cjs/react-router-dom.min.js"(exports) {
    ...
    var invariant2 = _interopDefault(require_tiny_invariant_cjs());
    function _extends2() {
    ...
    var BrowserRouter = function(n) {
      ...
      return _inheritsLoose2(e, n), e.prototype.render = function() {
        return React3.createElement(reactRouter.Router, { history: this.history, children: this.props.children });
      }, e;
    }(React3.Component);
    ...
    var forwardRef = React3.forwardRef;
    function isModifiedEvent(e) {
      return !!(e.metaKey || e.altKey || e.ctrlKey || e.shiftKey);
    }
    void 0 === forwardRef && (forwardRef = forwardRefShim);
    var LinkAnchor = forwardRef(function(e, t) {
      var r = e.innerRef, o = e.navigate, n = e.onClick, a = _objectWithoutPropertiesLoose2(e, ["innerRef", "navigate", "onClick"]), i = a.target, c = _extends2({}, a, { onClick: function(t2) {
        try {
          n && n(t2);
        } catch (e2) {
      ...
      return c.ref = forwardRefShim !== forwardRef && t || r, React3.createElement("a", c);
    });
    var Link = forwardRef(function(e, a) {
      var t = e.component, i = void 0 === t ? LinkAnchor : t, c = e.replace, u = e.to, s = e.innerRef, f = _objectWithoutPropertiesLoose2(e, ["component", "replace", "to", "innerRef"]);
      return React3.createElement(reactRouter.__RouterContext.Consumer, null, function(t2) {
        t2 || invariant2(false);
        var r = t2.history, e2 = normalizeToLocation(resolveToLocation(u, t2.location), t2.location), o = e2 ? r.createHref(e2) : "", n = _extends2({}, f, { href: o, navigate: function() {
          var e3 = resolveToLocation(u, t2.location);
          (c ? r.replace : r.push)(e3);
        } });
        return forwardRefShim !== forwardRef ? n.ref = a || s : n.innerRef = s, React3.createElement(i, n);
      });
    });
    var forwardRefShim$1 = function(e) {
      return e;
    };
    var forwardRef$1 = React3.forwardRef;
    ...
    var NavLink = forwardRef$1(function(e, f) {
      var t = e["aria-current"], l = void 0 === t ? "page" : t, r = e.activeClassName, p = void 0 === r ? "active" : r, R = e.activeStyle, h = e.className, d = e.exact, y = e.isActive, m = e.location, v = e.sensitive, b = e.strict, w = e.style, x = e.to, g = e.innerRef, P = _objectWithoutPropertiesLoose2(e, ["aria-current", "activeClassName", "activeStyle", "className", "exact", "isActive", "location", "sensitive", "strict", "style", "to", "innerRef"]);
      return React3.createElement(reactRouter.__RouterContext.Consumer, null, function(e2) {
        e2 || invariant2(false);
        var t2 = m || e2.location, r2 = normalizeToLocation(resolveToLocation(x, t2), t2), o = r2.pathname, n = o && o.replace(/([.+*?=^!:${}()[\]|/\\])/g, "\\$1"), a = n ? reactRouter.matchPath(t2.pathname, { path: n, exact: d, sensitive: v, strict: b }) : null, i = !!(y ? y(a, t2) : a), c = i ? joinClassnames(h, p) : h, u = i ? _extends2({}, w, {}, R) : w, s = _extends2({ "aria-current": i && l || null, className: c, style: u, to: r2 }, P);
        return forwardRefShim$1 !== forwardRef$1 ? s.ref = f || g : s.innerRef = g, React3.createElement(Link, s);
      });
    });
